...
class RevokedToken(Base):
    ...
    reason: Mapped[str] = mapped_column(String(50), nullable=False, default="logout")
    revoked_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), index=True)
